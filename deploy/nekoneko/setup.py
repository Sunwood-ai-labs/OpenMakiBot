...
defaults = {
    ...
    'OMB_DATA_ROOT': str(pathlib.Path.home() / 'nekoneko-guide'),
    'PODMAN_SOCKET': f'/run/user/{os.getuid()}/podman/podman.sock',
    'OMB_PORT': '29799', 'OMB_WEBHOOK_PORT': '29800', 'OMB_HTTP_PORT': '29880',
    ...
    'OMB_VM_IMAGE_REPOSITORY': 'localhost/openmausbot-nekoneko/cua-local-vm',
}
