> Archived upstream README at the OpenMakiBot fork baseline. Download, support and release links below refer to OpenMausBot, not OpenMakiBot. See [OpenMakiBot](README.md).
