...
import { Archive, ArchiveRestore, Clock3, FolderInput, Loader2, MoreHorizontal, Pencil, Trash2 } from "lucide-react";
...
export function SidebarThreadRow({ task, current, compact, folders, onSelect, onRename, onDelete, onMove, onArchive, activityLabel }: {
  task: ThreadRowTask;
  current: boolean;
  compact?: boolean;
  folders?: BotProject[];
